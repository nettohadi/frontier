...
const AUDIO_TAG_PATTERN = /\[(?:whispers?|laughs?|thoughtful|sighs?|clears?\s*throat|gasps?|sobs?|giggles?|cries|yells?|shouts?|screams?|curious|sad|excited|angry|happy)\]/gi;
